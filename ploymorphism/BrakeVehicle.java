...
public class BrakeVehicle {
	  String brand;
	    ...
	    BrakeVehicle() {//default constructor
	    ...
	    BrakeVehicle(String brand, String model, String vehicleNumber, String color,
	 ...
	 void brake()
	 {
		 System.out.println("breake applied");
	 }
		void display() {
	...
	class Car extends BrakeVehicle {
	    int seats;
	    String transmission;
	    boolean sunroof;
	    Car()
		...
		void brake() {
			System.out.println("Applied brake drum");
		}
	...
	class Bike extends BrakeVehicle {
	    int engineCCapacity;
		...
		void brake() {
			System.out.println("Applied brake air");
		}
		
		
	}//  Bike class ends here

	class Truck extends BrakeVehicle {
	    double loadCapacity;
	    int noOfWheels;
	    Truck()
	    {
		...
		void brake() {
			System.out.println("Applied brake Disk");
		}
		
		
	}//  Truck class ends here

	class DemoBrakeVehicle {
	    public static void main(String[] args) {
	        ...
	        System.out.println("\n");
	         ...
	         c1 = new Truck("Ashok Leyland", "CargoX", "MH14TR9087", "White", 2500000, 120,
